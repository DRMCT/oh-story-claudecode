...
2. **细纲必填项**：每个细纲（细纲_*.md）必须包含当前“章节蓝图”：
   ...
   - 细纲不给台词：情节点、内容概括、钩子里的对白写成意图，不写成整句（写"她当众把价问清、问他图什么"，不写引号里的原句）；复沓锚句只收律文、誓言、系统面板、旧案原话和前文已写出要回声的句子。写手把细纲当蓝图逐项落地，细纲里的原句会被原样抄进正文；人物的腔调与一场戏里的情绪走法在 `设定/角色/` 的角色卡上，台词由写手现写
