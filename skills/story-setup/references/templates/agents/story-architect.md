...
- 复沓锚句：{只收必须一字不差重现的既有文本：律文、誓言、系统面板、旧案原话、前文已写出且要回声的句子；一行一条、注明落在第几个情节点，如"点3：立此为凭…"；人物的日常对白不进这里，也不在情节点里写成整句台词，只写这句话要做到什么（她当众把价问清、他用一句吃饭的话应下），台词由写手按角色卡的腔调与"情绪过程"现写；没有写"无"}
